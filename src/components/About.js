...
function About() {
  return (
    <div className={styles.mainContainer}>
      ...
      <br />
      <br />
      Les liens et échanges, que j'ai tissé au fur et à mesure avec les patients
      et leurs propriétaires sont pour moi une source de bonheur. Continuer à
      servir la cause animal et prendre soins des animaux que je connais, et
      aussi faire la rencontre de nouveaux animaux dans un cadre plus familiale
      et avec une plus grande autonomie afin d'être d'avantage disponible, me
      tenez à coeur.
      <br />
      <br />
      ...
      <br />
      <br />
      Dévouée et passionnée des animaux, j'ai à coeur de prendre soins d'eux et
      de les rassurer durant vos absences. Je sais, au combien, vous aussi êtes
      inquiet à l'idée de les laisser entre de bonnes mains.
      <br />
      <br />
      Je connais leurs besoin physiologique et j'ai la connaissance des
      pathologies fréquentes afin de pouvoir vous accompagner de façon sereine.
      <br />
      <br />
